      ...
      <div class="modal-content whiteboards-exportasasset-modal">
        ...
        <div>
          ...
          <div
            ...
            role="alert"
            data-ng-bind="exportError"
            data-ng-if="exportError"
          ></div>
            ...
            <div class="row whiteboards-exportasset-container">
              ...
              <div class="col-xs-9">
                ...
                <div class="form-group" data-ng-class="{'has-error': whiteboardsExportAsAssetForm.$submitted && whiteboardsExportAsAssetForm.whiteboardsExportAsAssetTitle.$invalid}">
                  ...
                  <input
                    id="whiteboards-exportasasset-title"
                    type="text"
                    autofocus
                    name="whiteboardsExportAsAssetTitle"
                    class="form-control"
                    placeholder="Enter a title"
                    data-ng-model="asset.title"
                    data-ng-maxlength="255"
                    required
                    ng-disabled="isExporting"
                  >
                ...
                <div class="form-group">
                  ...
                  <select
                    id="whiteboards-exportasasset-category"
                    class="form-control"
                    data-value="{{asset.categories}}"
                    data-ng-model="asset.categories"
                    ng-disabled="isExporting"
                  >
                ...
                <div class="form-group">
                  ...
                  <textarea
                    id="whiteboards-exportasasset-description"
                    class="form-control"
                    placeholder="Add some more context to your whiteboard. You can use plain text or #keywords"
                    rows="3"
                    data-ng-model="asset.description"
                    ng-disabled="isExporting"
                  ></textarea>
                </div>
              </div>
