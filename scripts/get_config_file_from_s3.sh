...
# script must be run on the target EC2 instance (eg, squiggy-dev).
#
# -------------------------------------------------------------------
...
config_location="s3://squiggy-deploy-configs/squiggy/${eb_env}.py"
...
echo; echo "Done!"; echo
echo "Restart Squiggy to pick up new configs. Have a nice day!"; echo
